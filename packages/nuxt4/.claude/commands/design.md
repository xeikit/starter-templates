...
description: Create detailed design specification based on requirements (Stage 2 of Specification-Driven Development)
---
...
- If not, inform the user to run `/requirements` first.
